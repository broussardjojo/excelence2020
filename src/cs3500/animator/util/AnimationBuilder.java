...
/**
 * Builds an animation. I'm not documenting this any more.
 * @param <Doc> the type of animation.
 */
public interface AnimationBuilder<Doc> {
   ...
   * Our AbstractScene currently has fields minX, minY, maxX, maxY;
   * minx and miny can be taken directly from this, while
   * maxX = minX + width
   * maxY = minY + height
   * And changing our updateCanvas bad boy.
