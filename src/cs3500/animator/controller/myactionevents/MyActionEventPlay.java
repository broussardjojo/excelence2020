...
/**
 * This is a class that is a mock of an action event for playButton in the Mock Controller.
 */
public class MyActionEventPlay extends ActionEvent {
