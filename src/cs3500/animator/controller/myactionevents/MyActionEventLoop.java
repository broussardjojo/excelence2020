...
/**
 * This is a class that is a mock of an action event for loop in the Mock Controller.
 */
public class MyActionEventLoop extends ActionEvent {

  /**
   * Constructs the mock of the action event. Needs to contain a super of source, id, and
   * command since it extends ActionEvent.
   */
  public MyActionEventLoop() {
    super("", 1, "loop");
  }
