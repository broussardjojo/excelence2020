...
/**
 * This is a class that is a mock of an action event for slowDown in the Mock Controller.
 */
public class MyActionEventSlow extends ActionEvent {

  /**
   * Constructs the mock of the action event. Needs to contain a super of source, id, and
   * command since it extends ActionEvent.
   */
  public MyActionEventSlow() {
    super("", 1, "");
  }
