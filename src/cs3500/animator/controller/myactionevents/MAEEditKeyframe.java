...
/**
 * This is a class that is a mock of an action event for edit Keyframe in the Mock Controller.
 */
public class MAEEditKeyframe extends ActionEvent {
