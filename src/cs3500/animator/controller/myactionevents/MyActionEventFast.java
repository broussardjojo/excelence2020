...
/**
 * This is a class that is a mock of an action event for fastForward in the Mock Controller.
 */
public class MyActionEventFast extends ActionEvent {

  /**
   * Constructs the mock of the action event. Needs to contain a super of source, id, and
   * command since it extends ActionEvent.
   */
  public MyActionEventFast() {
    super("", 1, "");
  }
