...
/**
 * This is a class that is a mock of an action event for selectShapeForKeyframe in
 * the Mock Controller.
 */
public class MAESelectShapeForKeyFrame extends ActionEvent {
   ...
   */
  public MAESelectShapeForKeyFrame() {
    super("", 1, "");
  }
